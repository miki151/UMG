...
template <class T>
inline void serialize(PrettyInputArchive& ar1, NameValuePair<heap_optional<T>>& t) {
  handleNamePair(ar1, t.name, t.value, true);
}

template <class T>
inline void serialize(PrettyInputArchive& ar1, NameValuePair<optional_no_none<T>>& t) {
  handleNamePair(ar1, t.name, t.value, true);
}
